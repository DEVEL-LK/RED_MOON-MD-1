...
async function cinesubz_tvshow_info(query) {
    ...
    const $ = cheerio.load(body);
        ...
        // [නිවැරදි කරන ලද පේළිය]: Last Air Date සඳහා ස්ථාවර selector එකක් භාවිතා කරයි.
        const last_air_date = $("div.custom_fields:contains('Last Air Date:') span.valor").text().trim() || $("div.custom_fields:contains('Last Air Date:') span.valor1").text().trim();
        ...
        // [නිවැරදි කරන ලද පේළිය]: TV Series සඳහා Director ක්ෂේත්‍රය null ලෙස තබයි (දත්ත වැරදි ලෙස උපුටා ගැනීම වළක්වා ගැනීමට).
        const image = mainImage; 
        // [නිවැරදි කරන ලද පේළිය]: Image ක්ෂේත්‍රය mainImage එකට සමාන කරයි.
        const director = null; 
